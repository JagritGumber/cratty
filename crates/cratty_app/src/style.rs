...
pub const BG_SURFACE: Color = Color::from_rgb(0.214, 0.198, 0.243);  // #36323e popup shell
pub const BG_SURFACE_ALT: Color = Color::from_rgb(0.188, 0.173, 0.216); // #302c37 inset
...
pub const BORDER_SOFT: Color = Color::from_rgba(1.0, 1.0, 1.0, 0.08);
pub const BORDER_STRONG: Color = Color::from_rgba(1.0, 1.0, 1.0, 0.12);
pub const SHADOW_SOFT: Color = Color::from_rgba(0.0, 0.0, 0.0, 0.14);
pub const BACKDROP_DIM: Color = Color::from_rgba(0.0, 0.0, 0.0, 0.22);
